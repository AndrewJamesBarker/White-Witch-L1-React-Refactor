...
router.post('/auth/logout', authenticate, requireCsrf, logoutUser); // Logout user

// Routes for updating user information and game state
router.patch('/auth/info', authenticate, requireCsrf, updateUserInfo); // Update personal info
router.patch('/auth/gamestate', authenticate, requireCsrf, updateGameState); // Update game state
...
router.delete('/delete-account', authenticate, requireCsrf, deleteUser);
